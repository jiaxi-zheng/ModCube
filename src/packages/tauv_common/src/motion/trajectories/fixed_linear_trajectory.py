...
class LinearSegment(object):
    def __init__(self, p0, p1, h0, h1, params_lin, params_ang, start_velocity=(0, 0, 0), start_angular_velocity=0):
        ...
        print("I'm here LinearSegment 3 ********************")
        ...
        v1 = [0]
        print("I'm here LinearSegment 4 ********************")
        ...
        print("I'm here LinearSegment 5 ********************")
...
class LinearTrajectory(Trajectory):
    def __init__(self, start_pose, start_twist, positions, headings=None,
        ...
        print("I'm here LinearTrajectory 1 ********************")
        ...
        print("I'm here 2 LinearTrajectory ********************")
        ...
        print("I'm here 3 LinearTrajectory ********************")
        ...
        print("I'm here 7 LinearTrajectory ********************")
