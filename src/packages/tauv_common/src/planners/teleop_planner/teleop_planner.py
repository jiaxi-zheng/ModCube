...
class TeleopPlanner:
    ...
    def _handle_joy(self, msg: Joy):
        ...
        # print("joy_cmd.f_roll : ", joy_cmd.f_roll)
        # print("joy_cmd.use_f_roll : ", joy_cmd.use_f_roll)
        # print("joy_cmd.setpoint_roll : ", joy_cmd.setpoint_roll)
        # print("joy_cmd.use_setpoint_roll : ", joy_cmd.use_setpoint_roll)
        # print("################")
