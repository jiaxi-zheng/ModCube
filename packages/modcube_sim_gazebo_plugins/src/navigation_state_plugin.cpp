...
#include <modcube_sim_gazebo_plugins/navigation_state_plugin.h>
...
void NavigationStatePlugin::Load(physics::ModelPtr model, sdf::ElementPtr sdf)
{
  ...
  this->pubNavState = this->rosNode->advertise<modcube_msgs::NavigationState>(
...
void NavigationStatePlugin::OnUpdate(const common::UpdateInfo& info)
{
  ...
  modcube_msgs::NavigationState navStateMsg;
