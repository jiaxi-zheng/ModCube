...
def generate_python(yaml_path, output):
    ...
    python += '# This file is generated whenever modcube_common is built using catkin build.\n'
...
def generate_cpp(yaml_path, output):
    ...
    cpp += '// This file is generated whenever modcube_common is built using catkin build.\n'
