...
class StateEstimator {
  public:
    ...
    void handle_imu(const modcube_msgs::XsensImuData::ConstPtr& msg);
    void handle_dvl(const modcube_msgs::TeledyneDvlData::ConstPtr& msg);
    void handle_depth(const modcube_msgs::FluidDepth::ConstPtr& msg);
  ...
  private:
    ...
    modcube_alarms::AlarmClient alarm_client;
    ...
    bool handle_set_pose(modcube_msgs::SetPose::Request &req, modcube_msgs::SetPose::Response &res);
...
public:
  ...
  ImuMsg(const modcube_msgs::XsensImuData::ConstPtr &msg);
};
...
public:
  ...
  DvlMsg(const modcube_msgs::TeledyneDvlData::ConstPtr &msg);
};
...
public:
  ...
  DepthMsg(const modcube_msgs::FluidDepth::ConstPtr &msg);
};
...
public:
  ...
  SensorMsg(const modcube_msgs::XsensImuData::ConstPtr &msg) : msg(msg) {
    this->type = Type::IMU;
    this->stamp = msg->header.stamp;
  }

  SensorMsg(const modcube_msgs::TeledyneDvlData::ConstPtr &msg) : msg(msg) {
    this->type = Type::DVL;
    this->stamp = msg->header.stamp;
  }

  SensorMsg(const modcube_msgs::FluidDepth::ConstPtr &msg) : msg(msg) {
