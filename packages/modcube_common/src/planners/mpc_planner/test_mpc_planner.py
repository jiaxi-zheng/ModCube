import sys
sys.path.append('/path/to/parent/directory/of/modcube_common')
...
# from modcube_msgs.srv import GetTrajRequest, GetTrajResponse
from modcube_msgs.srv import GetTrajectory

from modcube_util.types import tl, tm
from modcube_util.transforms import rpy_to_quat

# from .mpc_planner import MPCPlanner
from modcube_common.planners.mpc_planner.mpc_planner import MPCPlanner
