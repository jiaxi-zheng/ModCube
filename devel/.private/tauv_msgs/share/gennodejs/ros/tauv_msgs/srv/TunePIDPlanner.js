...
class TunePIDPlannerRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type TunePIDPlannerRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type TunePIDPlannerRequest
    let len;
    let data = new TunePIDPlannerRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new TunePIDPlannerRequest(null);
...
class TunePIDPlannerResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type TunePIDPlannerResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type TunePIDPlannerResponse
    let len;
    let data = new TunePIDPlannerResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new TunePIDPlannerResponse(null);
...
module.exports = {
  Request: TunePIDPlannerRequest,
  Response: TunePIDPlannerResponse,
  md5sum() { return 'c6a95158ee66091a3c801f9968586b2d'; },
  datatype() { return 'tauv_msgs/TunePIDPlanner'; }
};
