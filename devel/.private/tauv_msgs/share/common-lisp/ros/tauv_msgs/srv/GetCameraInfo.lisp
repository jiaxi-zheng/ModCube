...
(cl:defmethod cl:initialize-instance :after ((m <GetCameraInfo-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetCameraInfo-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tauv_msgs-srv:<GetCameraInfo-request> is deprecated: use tauv_msgs-srv:GetCameraInfo-request instead.")))

(cl:ensure-generic-function 'camera_name-val :lambda-list '(m))
(cl:defmethod camera_name-val ((m <GetCameraInfo-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tauv_msgs-srv:camera_name-val is deprecated.  Use tauv_msgs-srv:camera_name instead.")
  (camera_name m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetCameraInfo-request>)))
  ...
  "tauv_msgs/GetCameraInfoRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetCameraInfo-request)))
  "Returns string type for a service object of type 'GetCameraInfo-request"
  "tauv_msgs/GetCameraInfoRequest")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<GetCameraInfo-request>)))
  ...
  "826084f2346d8aa4b94b352a93c8c998")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'GetCameraInfo-request)))
  "Returns md5sum for a message object of type 'GetCameraInfo-request"
  "826084f2346d8aa4b94b352a93c8c998")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<GetCameraInfo-request>)))
  ...
  (cl:format cl:nil "string camera_name~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'GetCameraInfo-request)))
  "Returns full string definition for message of type 'GetCameraInfo-request"
  (cl:format cl:nil "string camera_name~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <GetCameraInfo-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetCameraInfo-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tauv_msgs-srv:<GetCameraInfo-response> is deprecated: use tauv_msgs-srv:GetCameraInfo-response instead.")))

(cl:ensure-generic-function 'camera_info-val :lambda-list '(m))
(cl:defmethod camera_info-val ((m <GetCameraInfo-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tauv_msgs-srv:camera_info-val is deprecated.  Use tauv_msgs-srv:camera_info instead.")
  (camera_info m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetCameraInfo-response>)))
  ...
  "tauv_msgs/GetCameraInfoResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetCameraInfo-response)))
  "Returns string type for a service object of type 'GetCameraInfo-response"
  "tauv_msgs/GetCameraInfoResponse")
