...
(defsystem "tauv_msgs-srv"
  ...
  :components ((:file "_package")
    ...
    (:file "GetTrajectoryRequest_" :depends-on ("_package_GetTrajectoryRequest_"))
    (:file "_package_GetTrajectoryRequest_" :depends-on ("_package"))
    (:file "GetTrajectoryResponse_" :depends-on ("_package_GetTrajectoryResponse_"))
    (:file "_package_GetTrajectoryResponse_" :depends-on ("_package"))
